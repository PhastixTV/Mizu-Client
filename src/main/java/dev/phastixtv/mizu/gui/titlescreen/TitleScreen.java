package dev.phastixtv.mizu.gui.titlescreen;

import com.mojang.authlib.GameProfile;
import com.mojang.blaze3d.systems.RenderSystem;
import dev.phastixtv.mizu.Mizu;
import dev.phastixtv.mizu.util.font.IFont;
import dev.phastixtv.mizu.util.render.color.ColorUtil;
...
public class TitleScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(Mizu.INSTANCE.getTILESCREEN_BACKGROUND(), 0, 0, 20 * mouseX / this.width, 20 * mouseY / this.height, this.width + 20 * mouseX / this.width, this.height + 20 * mouseY / this.height, this.width + 40, this.height + 40);
        context.fillGradient(0, 0, this.width, this.height, 0x00000000, 0xff000000);


        String version = "v" + Mizu.INSTANCE.getVersion() + " - MC " + SharedConstants.getGameVersion().getName();
        ...
        context.drawTexture(Mizu.INSTANCE.getTILESCREEN_TITLE(), this.width / 2 - 110, this.height / 2 - 160, 0, 0, 220, 220, 220, 220);
